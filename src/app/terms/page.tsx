      ...
      <section style={{ maxWidth: '760px', margin: '0 auto' }}>
        ...
        <div style={{ borderTop: '0.5px solid #EDD9AF', paddingTop: '24px' }}>
          <p style={{ color: '#B8A090', fontFamily: 'var(--font-inter)', fontSize: '14px', lineHeight: 1.8 }}>
            These terms are a placeholder for the Just Because prototype. Replace this page with reviewed legal terms before accepting real orders, payments, or customer accounts.
          </p>
        </div>
      </section>
    </main>
