  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        eyebrow: ['12px', { letterSpacing: '0.22em', lineHeight: '1.5', fontWeight: '600' }],
        nav: ['15px', { lineHeight: '1' }],
        'card-title': ['18px', { lineHeight: '1.3' }],
        price: ['17px', { lineHeight: '1' }],
        'spec-label': ['11px', { letterSpacing: '0.18em', lineHeight: '1.5' }],
        'spec-value': ['22px', { lineHeight: '1.2' }],
      },
